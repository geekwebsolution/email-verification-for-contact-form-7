<?php
if (!class_exists('EVCF7_Update_Checker')) {

    class EVCF7_Update_Checker {
        ...
        public function check_for_updates($transient) {
            ...
            $transient_name = 'evcf7_plugin_updates';
